...
urlpatterns = [
    path('', views.my_library_view, name='library'),
    path('all_listings/', views.library_view, name='all_listings'),
    ...
    path('library/review/<int:book_id>/', views.edit_review, name='edit_review'),
